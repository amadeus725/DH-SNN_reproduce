...
from config import *
from data_loader import load_neurovpr_data

def create_model(config):
    """创建模型"""
    
    if 'dh_sfnn' == 'vanilla_sfnn':
        model = VanillaSFNN(
        ...
        raise ValueError(f"Unknown model type: dh_sfnn")
...
def main():
    ...
    # 加载数据
    train_loader, test_loader = load_neurovpr_data(
