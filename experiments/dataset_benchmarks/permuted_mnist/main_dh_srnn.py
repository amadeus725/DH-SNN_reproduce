...
from config import *
from data_loader import load_permuted_mnist_data
...
def main():
    ...
    print(f"🚀 PERMUTED_MNIST - DH_SRNN 实验")
    print("="*60)
    ...
    # 加载数据
    train_loader, test_loader = load_permuted_mnist_data(
