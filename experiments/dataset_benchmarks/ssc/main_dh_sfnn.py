...
def create_model(config, model_type='dh_sfnn'):
    """创建模型"""
    ...
    if model_type == 'vanilla_sfnn':
        ...
        model = DH_SFNN(
            ...
            hidden_dims=[config['hidden_size']],  # 转换为列表
            output_dim=config['output_size'],
            num_branches=DH_CONFIG['num_branches'],
            v_threshold=config['v_threshold'],
            tau_m_init=DH_CONFIG['tau_m_init'],
            tau_n_init=DH_CONFIG['tau_n_init'],
            step_mode='m'  # 多步模式
        )
