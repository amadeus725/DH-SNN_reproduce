...
class TIMITDataset(Dataset):
    ...
    def _load_data(self):
        ...
        if self.split == 'train':
            data_file = os.path.join(self.data_path, f'timit_train.h5.gz')
        else:
            data_file = os.path.join(self.data_path, f'timit_test.h5.gz')
...
def load_timit_data(data_path, batch_size, num_workers=4):
    """
    加载TIMIT数据
...
if __name__ == '__main__':
    # 测试数据加载器
    train_loader, test_loader = load_timit_data('../datasets/timit/', 32)
