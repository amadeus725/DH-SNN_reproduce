...
from config import *
from data_loader import load_timit_data

def create_model(config):
    """创建模型"""
    
    if 'dh_srnn' == 'vanilla_sfnn':
        model = VanillaSFNN(
        ...
        raise ValueError(f"Unknown model type: dh_srnn")
...
def main():
    ...
    print(f"🏗️ 模型: DH_SRNN")
    
    # 加载数据
    train_loader, test_loader = load_timit_data(
    ...
    torch.save(results, f"{EXPERIMENT_CONFIG['output_dir']}/dh_srnn_results.pth")
