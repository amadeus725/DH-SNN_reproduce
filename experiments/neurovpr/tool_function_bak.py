...
class SequentialDataset(Dataset):
    ...
    def __init__(self, data_dir, exp_idx, transform, nclass=None, seq_len_aps=None, seq_len_dvs = None,
        ...
        # Adapt to our dataset structure: use dvs_7ms_3seq instead of dvs_5ms_5seq
    ...
    def __getitem__(self, idx):
        ...
        dvs_seq = torch.zeros(self.seq_len_dvs * 3, 2, 32, 43)
        ...
        for i in range(self.seq_len_dvs):
            ...
            dvs_seq[i * 3: (i + 1) * 3] = torch.nn.functional.avg_pool2d(dvs_buf, 8)
